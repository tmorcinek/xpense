...
class JanuaryData(categoryManager: CategoryManager) : MockData(categoryManager) {
    ...
    override fun expenses(): List<Expense> = listOf(
            ...
            createExpense(30, "Chocolate Roti", food, "29/02/2016"),
            createExpense(119, "Dinner", other, "29/02/2016"),
            createExpense(30, "Lunch", food, "29/02/2016"),
            createExpense(26, "Breakfast", food, "29/02/2016"),
            createExpense(70, "Train station transport", transportation, "29/02/2016"),

            createExpense(7000, "Bangkok Trip Summary", other, "27/02/2016"),

            createExpense(200, "Airport shuttle", leisure, "24/02/2016"),
